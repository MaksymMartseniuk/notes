...
from .views import (CreateUserView ,ProfileUserView,LogoutView, ChangePasswordView,
                    ...
                    PasswordValidateView,SetEmailView,VerifyEmailCodeView,ChangeUsernameView,AutoSaveSettingsView,SupportRequestView,DeleteAccountView)
...
urlpatterns = [
    ...
    path('users/delete_account/', DeleteAccountView.as_view(), name='delete_account'),
